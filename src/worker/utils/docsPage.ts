...
<html lang="en">
  <head>
    ...
    <style>
      ...
      body { margin: 0; font-family: Inter, system-ui, sans-serif; background: #07090d; color: #e2e8f0; }
      main { max-width: 920px; margin: 0 auto; padding: 48px 20px; }
      h1 { margin-top: 0; font-size: 2rem; }
      p, li { color: #94a3b8; }
      .card { border: 1px solid rgba(255,255,255,.12); background: rgba(13,17,23,.9); border-radius: 12px; padding: 16px; margin-top: 16px; }
      a { color: #67e8f9; }
    </style>
  </head>
  <body>
    <main>
      ...
      <div class="card">
        <p>App: <a href="https://hexyr.com">https://hexyr.com</a></p>
      </div>
    </main>
  </body>
</html>
